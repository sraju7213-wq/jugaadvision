...
const TABS_RIGHT = [
  { id: "ideas", label: "Ideas", path: "/library", icon: Bookmark },
  ...
  return (
    ...
    >
      <div className="flex items-end px-2 pt-1">
        ...
        {/* Center Create FAB */}
        <div className="flex flex-col items-center px-1 -mt-6">
          <button
            type="button"
          ...
          <span
            className={`text-[10px] tracking-wide mt-1 leading-none ${
              isCreateActive ? "text-[var(--editorial-coral)] font-bold" : "text-[var(--editorial-muted)] font-medium"
            }`}
          >
            Create
          </span>
